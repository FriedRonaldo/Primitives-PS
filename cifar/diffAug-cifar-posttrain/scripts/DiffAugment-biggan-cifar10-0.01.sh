#!/bin/bash
python train.py --experiment_name DiffAugment-biggan-cifar10-0.01 --DiffAugment translation,cutout \
--mirror_augment --use_multiepoch_sampler \
--which_best FID --num_inception_images 10000 \
--shuffle --batch_size 50 \
--num_G_accumulations 1 --num_D_accumulations 1 --num_epochs 50000 --num_samples 500 \
