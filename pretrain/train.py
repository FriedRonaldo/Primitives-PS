...
def copytree(src, dst, ignore=['results'], symlinks=False):
...
def setup_training_loop_kwargs(
    ...
    args.training_set_kwargs = dnnlib.EasyDict(class_name='noise_dataset.NoiseDataset', path=data, use_labels=True, max_size=None, xflip=False)
    ...
    cfg_specs = {
        ...
        'low_shot':  dict(ref_gpus=-1, kimg=300,    mb=16,  mbstd=4,  fmaps=1,   lrate=0.002,  gamma=10,   ema=10,  ramp=None, map=2, snap=10),
...
def main(ctx, outdir, dry_run, **config_kwargs):
    ...
    codedir = os.path.join(args.run_dir, 'codes')
    copytree('./', codedir, ignore=['results'])
